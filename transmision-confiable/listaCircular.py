...
class listaCircular:
	...
	def getElemento(self, numeroDePaquete):
		if numeroDePaquete >= 10:
			posicionABuscar = ((numeroDePaquete - numeroDePaqueteActual) + self.inicio) - 10#Calculamos la posicion en la que deberia estar ese paquete en el array circular
		else:
		...
		int.from_bytes(dataBytes, byteorder='big')
